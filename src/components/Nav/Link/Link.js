...
const Link = ({data, isActive, setSelectedIndicator}) => {
  ...
  return (
    ...
    {title === "UNBORING"?<a href={href} target="_blank"><img className="unboring_nav_image" src={require("../../../images/navbar/unmboring tm@3x.png")} alt="" /></a> : <AnchorLink href={href} className={`segment-text`} style={{}}>{title}</AnchorLink>}
